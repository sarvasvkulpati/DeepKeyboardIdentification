...
#     currentLetter = event.name
#     currentTime = event.time

#     if currentLetter is prevLetter:
#         holdTime = currentTime - prevTime

#         events.append((currentLetter, holdTime))
#     else:
#         upDownTime = currentTime - prevTime
#         events.append(('line', upDownTime))
#     prevLetter = currentLetter  
#     prevTime = currentTime
## algo above doesn't work, doesn't take into account multiple keys being pressed at the same time
