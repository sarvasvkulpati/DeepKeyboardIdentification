...
#         size = 5
#         print(imgx, imgx+size, imgy, imgy+size)
#         # draw.ellipse((0, 5, 0, 5), fill = 'red', outline ='blue')
#         draw.ellipse((imgx, imgy, imgx+size, imgy+size), fill = 'red', outline ='blue')
#         # im.show()
#         im.save("img.png")

#         break

# keyboard.on_press(lambda e: process_press(e))
# keyboard.on_release(lambda e: process_press(e, False))

# def process_press(letter, is_pressed=True):
#     if is_pressed:

#         print(letter.name + "pressed down at " + str(letter.time))
#     else:
#         print(letter.name + "released at " + str(letter.time))
